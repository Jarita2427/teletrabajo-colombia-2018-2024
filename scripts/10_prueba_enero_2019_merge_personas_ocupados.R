# Objetivo: construir base mensual (Enero 2019) de mujeres ocupadas, uniendo Personas + Ocupados, resolviendo duplicados y dejando variables clave.
...
personas <- leer_modulo_mes(month_dir, "Caracter")
...
cat("Duplicados por persona: ", nrow(dup_final), "\n")
